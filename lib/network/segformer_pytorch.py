...
class MiT(nn.Module):
    def __init__(
        ...
        # dim_pairs: [(3, 32), (32, 64), (64, 128), (128, 256)]
        # kernel --- [7,        3,        3,         3]
        # stride --- [4,        2,        2,         2]
        # padding -- [3,        1,        1,         1]
...
if __name__ == "__main__":
    print("debug")
    data_path = "/Users/mr.chai/Library/Mobile Documents/" \
                "com~apple~CloudDocs/Desktop_hided/Desktop_Backup/mask_with_img.npy"
