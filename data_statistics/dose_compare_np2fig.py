...
output_path = "/Users/mr.chai/Desktop/499399_predwithmask"
...
# for z in range(minus.shape[2]):
#     print(np.max(minus[:, :, z]))
...
# z = 4
    ...
    f3 = plt.imshow(minus[256:768, 256:768, 10*z + 5], cmap="Blues", vmin= 0, vmax=20)
